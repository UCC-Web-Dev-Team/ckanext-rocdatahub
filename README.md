...
3. Add `rocdatahub` to the `ckan.plugins` setting in your CKAN
...
**TODO:** Document any optional config settings here. For example:
	...
	# (optional, default: 24).
	ckanext.rocdatahub.some_setting = some_default_value
...
## Releasing a new version of ckanext-rocdatahub

If ckanext-rocdatahub should be available on PyPI you can follow these steps to publish a new version:
